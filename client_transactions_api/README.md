[![Python Test CI](https://github.com/mbrav/client-transactions-api/actions/workflows/fastapi.yml/badge.svg)](https://github.com/mbrav/client-transactions-api/actions/workflows/fastapi.yml)
